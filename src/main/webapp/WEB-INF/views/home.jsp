...
<div id="main">
    ...
    <div id="header" class="navbar navbar-fixed-top">
        <div class="navbar-inner">
        	<div class="brand"><span id="productName"> ${fns:getStringProperty('productName','NIS')}</span></div>
                <ul id="userControl" class="nav pull-right">
	              	...
	              	<li id="themeSwitch" class="dropdown">
						...
						<ul class="dropdown-menu">
							<c:forEach items="${fns:getDictList('SYS_THEME')}" var="dict"><li><a href="#" onclick="location='${pageContext.request.contextPath}/theme/${dict.itemCode}?url='+location.href">${dict.itemValue}</a></li></c:forEach>
					...
					<li><a href="${pageContext.request.contextPath }/logout" title="退出登录"><i class="icon-circle-arrow-right"></i>&nbsp;退出</a></li>
					<li>&nbsp;</li>
                </ul>
          				 			...
          				 			<div class="accordion-group">
          				 				<div class="accordion-heading">
				                            <a href="#collapse_${secondMenu.id}" data-parent="#menu-${menu.id }" data-toggle="collapse" class="accordion-toggle">
				                                ${secondMenu.name} <i class="icon-chevron-right"></i>
				                            </a>
			                      		</div>
		...
		var App = function() {
			...
			var menu_header_active = function($this){
				...
				if($flag.hasClass("icon-chevron-down")){
					$flag.removeClass('icon-chevron-down').addClass('icon-chevron-right');
					return;
				}
				
				var thisAccordion = $('#left');
				thisAccordion.find('.accordion-heading a').children("i").removeClass('icon-chevron-down').addClass('icon-chevron-right');
				
				$flag.removeClass('icon-chevron-right').addClass('icon-chevron-down');
